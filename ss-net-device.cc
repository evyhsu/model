...
//yen
    .AddAttribute ("YenSSHandover",
                   "call handover function.",
                   PointerValue (),
                   MakePointerAccessor (&SubscriberStationNetDevice::GetYenSSHandover,
                                        &SubscriberStationNetDevice::SetYenSSHandover),
                   MakePointerChecker<YenSSHandover> ())
...
//yen
Ptr<YenSSHandover>
SubscriberStationNetDevice::GetYenSSHandover () const
{
  return m_yensshandover;
}

void
SubscriberStationNetDevice::SetYenSSHandover (Ptr<YenSSHandover> yensshandover )
{
  m_yensshandover = yensshandover;
}
